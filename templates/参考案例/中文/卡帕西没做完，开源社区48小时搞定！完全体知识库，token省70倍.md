---
title: "卡帕西没做完，开源社区48小时搞定！完全体知识库，token省70倍"
source: "https://www.toutiao.com/article/7625889327771337262/?app=news_article&category_new=__all__&module_name=Android_tt_others&share_did=MS4wLjACAAAAcbYui8GOvjnUIZhAnk6N9gGiyRYJg-Fw3FxRuULj09Q&share_uid=MS4wLjABAAAALXlKY4ZwoGGw80-JC2Ig4GAhWz0ZNI8e37Ppk1YhpMI&timestamp=1775551120&tt_from=wechat&upstream_biz=Android_wechat&utm_campaign=client_share&utm_medium=toutiao_android&utm_source=wechat&share_token=36cba598-48b4-4465-a48f-3821306889bf&source=m_redirect"
author:
  - "[[量子位]]"
published: 2026-04-07
created: 2026-04-07
description: "Karpathy分享的个人知识库爆火出圈，48小时就有人拿着完全体送货上门。Graphify，一款零配置、全模态、本地跑、还特能省token的知识图谱工具，GitHub开源狂揽2k+ Star。"
tags:
  - "clippings"
---
> 闻乐 发自 凹非寺
...
![](https://p3-sign.toutiaoimg.com/tos-cn-i-axegupay5k/94ac6dfaa6984d09931157fd577a058b~tplv-tt-origin-web:gif.jpeg?_iz=58558&from=article.pc_detail&lk3s=953192f4&x-expires=1776161780&x-signature=R01F9UdAI9AG0geJ8svFmAV36H8%3D)

**Graphify** ，一款零配置、全模态、本地跑、还特能省token的知识图谱工具，GitHub开源狂揽2k+ Star。

![](https://p26-sign.toutiaoimg.com/tos-cn-i-6w9my0ksvp/abb6bba93eb440d7976ae77f7562ae77~tplv-tt-origin-web:gif.jpeg?_iz=58558&from=article.pc_detail&lk3s=953192f4&x-expires=1776161780&x-signature=tFUHVsv9X3xtVkvHUl%2BfR7HZHzQ%3D)

不仅能自动构建可导航知识图谱、自带反向链接和关系溯源，更实现 **71.5倍token消耗节省** ，直接把卡神的/raw笔记法进化到了完全体。
...
在此基础上，它还依靠 **本地AST解析与并行LLM子代理语义提取的双阶段流程** ，实现了 **71.5 倍Token消耗优化** 。
...
更友好的是，它全程 **无需向量数据库、无需嵌入计算、也不用复杂配置** ，做到了 **开箱即用** 。
...
- Codex用户：想用上Graphify说的并行LLM子代理提取，必须先在配置文件 **~/.codex/config.toml** 的 **\[features\]** 里打开 **multi\_agent = true** ，不然跑不起来并行模式。
...
Graphify的作者 **Safi Shamsi** 现为伦敦Valent公司的一名AI研究员。
...
参考链接：  
https://x.com/socialwithaayan/status/2041192946369007924x
