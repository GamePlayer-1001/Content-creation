---
title: "wimi321/macos-computer-use-skill: Top-level macOS computer-use skill with a bundled standalone runtime and MCP server."
source: "https://github.com/wimi321/macos-computer-use-skill"
author:
  - "[[GitHub]]"
published:
created: 2026-04-02
description: "Top-level macOS computer-use skill with a bundled standalone runtime and MCP server. - wimi321/macos-computer-use-skill"
tags:
  - "clippings"
---
[![macos-computer-use-skill hero](https://github.com/wimi321/macos-computer-use-skill/raw/main/assets/hero.svg)](https://github.com/wimi321/macos-computer-use-skill/blob/main/assets/hero.svg)

## macOS Computer-Use Skill

**A top-level portable skill for macOS with a bundled standalone runtime and MCP server.**

[GitHub](https://github.com/wimi321/macos-computer-use-skill) · [ClawHub](https://clawhub.ai/wimi321/computer-use-macos) · [简体中文](https://github.com/wimi321/macos-computer-use-skill/blob/main/README.zh-CN.md) · [日本語](https://github.com/wimi321/macos-computer-use-skill/blob/main/README.ja.md)
...
See [`examples/mcp-config.json`](https://github.com/wimi321/macos-computer-use-skill/blob/main/examples/mcp-config.json).

## Skill Install

This repo ships a top-level skill at [`skill/computer-use-macos`](https://github.com/wimi321/macos-computer-use-skill/blob/main/skill/computer-use-macos).
