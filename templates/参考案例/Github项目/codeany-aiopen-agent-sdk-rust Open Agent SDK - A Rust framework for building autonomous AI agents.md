---
title: "codeany-ai/open-agent-sdk-rust: Open Agent SDK - A Rust framework for building autonomous AI agents"
source: "https://github.com/codeany-ai/open-agent-sdk-rust"
author:
published:
created: 2026-04-03
description: "Open Agent SDK - A Rust framework for building autonomous AI agents - codeany-ai/open-agent-sdk-rust"
tags:
  - "clippings"
---
## Open Agent SDK (Rust)
...
| # | Example | Description |
| --- | --- | --- |
| 01 | [Simple Query](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/01-simple-query.rs) | Streaming query with tool calls |
| 02 | [Multi-Tool](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/02-multi-tool.rs) | Glob + Bash multi-tool orchestration |
| 03 | [Multi-Turn](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/03-multi-turn.rs) | Multi-turn conversation with session persistence |
| 04 | [Prompt API](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/04-prompt-api.rs) | Blocking `prompt()` for one-shot queries |
| 05 | [Custom System Prompt](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/05-custom-system-prompt.rs) | Custom system prompt for code review |
| 06 | [MCP Server](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/06-mcp-server.rs) | MCP server integration (stdio transport) |
| 07 | [Custom Tools](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/07-custom-tools.rs) | Define and use custom tools |
| 08 | [One-shot Query](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/08-oneshot-query.rs) | Quick one-shot agent query |
| 09 | [Subagents](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/09-subagents.rs) | Specialized subagent with restricted tools |
| 10 | [Permissions](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/10-permissions.rs) | Read-only agent with allowed tools |
| 11 | [Web Chat](https://github.com/codeany-ai/open-agent-sdk-rust/blob/main/examples/web) | Web-based chat UI with streaming |
