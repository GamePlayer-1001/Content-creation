---
title: "Harness Engineering 最佳实践：从概念到落地的完整操作手册"
source: "https://www.cnblogs.com/informatics/p/19812585?module_name=Android_tt_others&tt_from=wechat&upstream_biz=Android_wechat&utm_campaign=client_share&utm_medium=toutiao_android&utm_source=wechat&share_token=0107e4e7-02f4-4974-bbd4-64fef95eb8e0"
author:
  - "[[warm3snow]]"
published: 2026-04-02
created: 2026-05-18
description: "Harness Engineering 最佳实践：从概念到落地的完整操作手册 本文是 Harness Engineering 上篇 的续篇。上篇解读了 OpenAI 的方法论——什么是 Harness Engineering、核心理念、五大工程实践和哲学内核。本篇不再重复概念，直接进入实操：怎么在你"
tags:
  - "clippings"
---
[合集 - AI(45)](https://www.cnblogs.com/informatics/collections/18354)

[1.文生SQL](https://www.cnblogs.com/informatics/p/18303666) [2.SQLCoder部署和应用](https://www.cnblogs.com/informatics/p/18303862) [3.五分钟搭建属于你的AI助手：Ollama+DeepSeek+AnythingLLM深度整合教程](https://www.cnblogs.com/informatics/p/18704799) [4.Ollama + Open-WebUI一键安装&避坑指南](https://www.cnblogs.com/informatics/p/18710395) [5.在 VSCode 中使用 Ollama 插件进行智能 Chat：安装、配置与体验](https://www.cnblogs.com/informatics/p/18724013) [6.一文入门Agent MCP](https://www.cnblogs.com/informatics/p/19006333) [7.Sherlock：用自然语言重新定义SSH远程操作体验](https://www.cnblogs.com/informatics/p/19310870) [8.规范驱动开发（SDD）](https://www.cnblogs.com/informatics/p/19327172) [9.别再花钱买云服务器了！OpenClaw 本地部署保姆级教程，10分钟拥有私人AI助手](https://www.cnblogs.com/informatics/p/19623140) [10.电影《Her》照进现实！用 OpenClaw 打造你的 AI 女友 Clawra，一行代码拥有她](https://www.cnblogs.com/informatics/p/19624149) [11.AI 时代，程序员和产品经理的生存指南：边界消融后，我们该何去何从？](https://www.cnblogs.com/informatics/p/19625376) [12.4000行代码干翻OpenClaw？2026 AI助手三巨头终极对决](https://www.cnblogs.com/informatics/p/19626438) [13.OpenClaw 为什么大火？GitHub 史上增长最快的开源项目，凭什么？](https://www.cnblogs.com/informatics/p/19629836) [14.Nanobot：超轻量级 AI Agent 框架，4000 行代码实现智能助手](https://www.cnblogs.com/informatics/p/19629932) [15.45亿红包砸不出"微信时刻"：春节AI大战背后的真相](https://www.cnblogs.com/informatics/p/19630841) [16.当 AI Agent 接管你的钱包：未来支付体系的终极演进](https://www.cnblogs.com/informatics/p/19631662) [17.AI Agent 协议全景：A2A、AP2、x402 如何拼出智能体经济的完整拼图](https://www.cnblogs.com/informatics/p/19632890) [18.A2A 协议深度解析：让所有 AI Agent 说同一种语言](https://www.cnblogs.com/informatics/p/19632891) [19.AP2 协议深度解析：当 AI Agent 要刷你的信用卡，规则该怎么定？](https://www.cnblogs.com/informatics/p/19632893) [20.x402 协议深度解析：用一个 HTTP 状态码，重建互联网的支付层](https://www.cnblogs.com/informatics/p/19632894) [21.OPC（一人公司）：AI 时代的组织革命，一个人如何调度"千军万马"？](https://www.cnblogs.com/informatics/p/19642782) [22.Claude Code 黑客马拉松：5 个获奖项目，没有一个是"纯码农"做的](https://www.cnblogs.com/informatics/p/19653172) [23.AI IDE 的 Plan、Agent、Ask、Edit、Builder……到底在搞什么？一文讲透模式战争](https://www.cnblogs.com/informatics/p/19657054) [24.当 AI 瞄准人类：美伊战争打响第一枪，我们每个人都该清醒了](https://www.cnblogs.com/informatics/p/19658984) [25.我用 OpenClaw 跑了两周量化交易，结果翻车了](https://www.cnblogs.com/informatics/p/19668938) [26.ClawHub 必装 Skills 清单：从 13000+ 技能中精选，让你的 OpenClaw 真正能打](https://www.cnblogs.com/informatics/p/19679935) [27.装完 OpenClaw 之后，我把它变成了办公助手——一个月真实体验](https://www.cnblogs.com/informatics/p/19679940) [28.OpenClaw 装机 1000 元？深度拆解代装产业链：谁在赚钱，谁在裸奔](https://www.cnblogs.com/informatics/p/19679944) [29.AI 重塑产品管理工具：从 Jira 到智能体项目经理的终极演进](https://www.cnblogs.com/informatics/p/19692668) [30."给我发个200元红包"：一条群消息背后的 AI 安全危机](https://www.cnblogs.com/informatics/p/19698462) [31.当 AI 学会"造世界"——从 MiroFish 看群体智能预测万物的可能与不可能](https://www.cnblogs.com/informatics/p/19704252) [32.想搭上 AI 这趟车？你不需要先学编程](https://www.cnblogs.com/informatics/p/19710287) [33.GraphRAG：当 RAG 遇上知识图谱，信息检索从此不一样了](https://www.cnblogs.com/informatics/p/19715106) [34.从 MCP 到 CLI：AI Agent 的"接口之争"，终端才是终局](https://www.cnblogs.com/informatics/p/19717591) [35.腾讯 CodeBuddy + WorkBuddy：从写代码到管周报，一个 AI 生态通吃全场景](https://www.cnblogs.com/informatics/p/19722426) [36.从金牛奖到 DeepSeek：一场演讲如何预言了中国 AI 的未来](https://www.cnblogs.com/informatics/p/19735479) [37.ERC-8183：给 Agent 经济补上最后一块拼图](https://www.cnblogs.com/informatics/p/19737408) [38.Harness Engineering：当人类不再写代码，软件工程反而更"工程"了](https://www.cnblogs.com/informatics/p/19740439) [39.微信正式接入 OpenClaw：12 亿用户的 AI Agent 入口，来了](https://www.cnblogs.com/informatics/p/19751397) [40.Claude Code 源码泄露全复盘：51.2 万行代码裸奔，Anthropic 在同一个坑里摔了两次](https://www.cnblogs.com/informatics/p/19808410)

41.Harness Engineering 最佳实践：从概念到落地的完整操作手册

[42.「同事.skill」爆火：当 AI 学会"炼化"你的同事](https://www.cnblogs.com/informatics/p/19826251) [43.用 AI 构建巴菲特投资知识图谱：从 48 封公开信到可交互的投资智慧网络](https://www.cnblogs.com/informatics/p/19836759) [44.一张图看懂巴菲特 48 年投资帝国：知识图谱效果全展示](https://www.cnblogs.com/informatics/p/19836825) [45.从龙虾到爱马仕：一个老虾农的"叛逃"实录](https://www.cnblogs.com/informatics/p/19873845)

> 本文是 [Harness Engineering 上篇](https://www.cnblogs.com/informatics/p/harness-engineering-deep-dive.md) 的续篇。上篇解读了 OpenAI 的方法论——什么是 Harness Engineering、核心理念、五大工程实践和哲学内核。 **本篇不再重复概念，直接进入实操** ：怎么在你自己的项目中落地 Harness Engineering，用什么工具，踩什么坑，有哪些可以直接抄的模板。
...
│     天然避免上下文污染和任务干扰                           │
├──────────────────────────────────────────────────────┤
│  5. Test-Driven Development（强制！）                   │
│     RED → GREEN → REFACTOR                            │
│     ⚠️ 如果 Agent 先写代码再写测试，代码会被删除           │
├──────────────────────────────────────────────────────┤
│  6. Code Review                                       │
│     自动按规范检查代码质量                                │
├──────────────────────────────────────────────────────┤
│  7. Finishing Branch                                   │
│     验证所有测试通过 → 合并 → 清理 worktree              │
└──────────────────────────────────────────────────────┘
```
...
- 确保每条规则的 FIX 信息 **给出具体代码片段** ，而不是模糊的建议
- 互相冲突的规则只保留一条
...
> **参考资料**
> 
> - 上篇： [Harness Engineering：当人类不再写代码，软件工程反而更"工程"了](https://www.cnblogs.com/informatics/p/harness-engineering-deep-dive-origin.md)
> - OpenAI： [Harness engineering: leveraging Codex in an agent-first world](https://openai.com/index/harness-engineering/)
> - [Superpowers](https://github.com/obra/superpowers) — Agent 技能框架（127k ⭐）
> - [OpenHands](https://github.com/All-Hands-AI/OpenHands) — AI 软件开发平台（50k+ ⭐）
> - [Aider](https://github.com/Aider-AI/aider) — 终端 AI 结对编程（30k+ ⭐）
> - [Cline](https://github.com/cline/cline) — VS Code Agent（40k+ ⭐）
> - [SWE-agent](https://github.com/princeton-nlp/SWE-agent) — 自主修复 Agent（15k+ ⭐）
> - [deusyu/harness-engineering](https://github.com/deusyu/harness-engineering) — 学习指南（310 ⭐）
> - [harness-engineering.ai](https://harness-engineering.ai/) — 知识图谱（883 实体）

## 转载声明

本文来自博客园，作者： [warm3snow](https://www.cnblogs.com/informatics/)

转载请注明原文链接： [https://www.cnblogs.com/informatics/p/19812585](https://www.cnblogs.com/informatics/p/19812585)
